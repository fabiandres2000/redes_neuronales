function varargout = punto3(varargin)
% PUNTO3 MATLAB code for punto3.fig
%      PUNTO3, by itself, creates a new PUNTO3 or raises the existing
%      singleton*.
%
%      H = PUNTO3 returns the handle to a new PUNTO3 or the handle to
%      the existing singleton*.
%
%      PUNTO3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PUNTO3.M with the given input arguments.
%
%      PUNTO3('Property','Value',...) creates a new PUNTO3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before punto3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to punto3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help punto3

% Last Modified by GUIDE v2.5 05-Nov-2020 19:10:48

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @punto3_OpeningFcn, ...
                   'gui_OutputFcn',  @punto3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before punto3 is made visible.
function punto3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to punto3 (see VARARGIN)

% Choose default command line output for punto3
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes punto3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = punto3_OutputFcn(hObject, eventdata, handles) 
...
if isequal(file,0)
   ...
   opts = detectImportOptions(name_file);
   opts.SelectedVariableNames = {'Var3'};
       ...
       while(iteracion <= iteraciones) 
           ...
           if RMS <= errormaximo
               ...
               historial
                ...
                %------------------grafico--------------------
                %------------------guardo pesos----------------------------       
                 writematrix(w,'C:\Users\fabia\Desktop\IA\elemento_punto_3\pesos_capa_1.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_3\pesos_capa_1.txt
                 writematrix(w2,'C:\Users\fabia\Desktop\IA\elemento_punto_3\pesos_capa_salida.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_3\pesos_capa_salida.txt
                 
                 writematrix(u,'C:\Users\fabia\Desktop\IA\elemento_punto_3\umbrales_capa_1.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_3\umbrales_capa_1.txt          
                 writematrix(u2,'C:\Users\fabia\Desktop\IA\elemento_punto_3\umbrales_capa_salida.txt','Delimiter',';');
