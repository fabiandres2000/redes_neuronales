function varargout = punto7(varargin)
% PUNTO7 MATLAB code for punto7.fig
%      PUNTO7, by itself, creates a new PUNTO7 or raises the existing
%      singleton*.
%
%      H = PUNTO7 returns the handle to a new PUNTO7 or the handle to
%      the existing singleton*.
%
%      PUNTO7('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PUNTO7.M with the given input arguments.
%
%      PUNTO7('Property','Value',...) creates a new PUNTO7 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before punto7_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to punto7_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help punto7

% Last Modified by GUIDE v2.5 08-Nov-2020 00:28:32

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @punto7_OpeningFcn, ...
                   'gui_OutputFcn',  @punto7_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before punto7 is made visible.
function punto7_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to punto7 (see VARARGIN)

% Choose default command line output for punto7
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes punto7 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = punto7_OutputFcn(hObject, eventdata, handles) 
...
if isequal(file,0)
   ...
   opts = detectImportOptions(name_file);
   opts.SelectedVariableNames = {'Var4','Var5'};
       ...
       while(iteracion <= iteraciones) 
           ...
           if RMS <= errormaximo
               ...
               historial
                ...
                %------------------grafico--------------------
                %------------------guardo pesos----------------------------       
                 writematrix(w,'C:\Users\fabia\Desktop\IA\elemento_punto_7\pesos_capa_1.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_7\pesos_capa_1.txt
                 writematrix(w2,'C:\Users\fabia\Desktop\IA\elemento_punto_7\pesos_capa_salida.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_7\pesos_capa_salida.txt
                 
                 writematrix(u,'C:\Users\fabia\Desktop\IA\elemento_punto_7\umbrales_capa_1.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_7\umbrales_capa_1.txt          
                 writematrix(u2,'C:\Users\fabia\Desktop\IA\elemento_punto_7\umbrales_capa_salida.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_7\umbrales_capa_salida.txt
               ...
               for k = 1:Salidas
                for l = 1:nc2
                    if(k==1)
                     ...
                     w3(k,l) = w3(k,l)+rata*Elineal_2*salidas2(1,2);
                    end
                end
               end
               disp('w3 modificado')
           ...
           if RMS <= errormaximo
               ...
               historial
                %------------------grafico--------------------
                 ...
                 writematrix(w,'C:\Users\fabia\Desktop\IA\elemento_punto_7\pesos_capa_1.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_7\pesos_capa_1.txt
                 writematrix(w2,'C:\Users\fabia\Desktop\IA\elemento_punto_7\pesos_capa_2.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_7\pesos_capa_2.txt
                 writematrix(w3,'C:\Users\fabia\Desktop\IA\elemento_punto_7\pesos_capa_salida.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_7\pesos_capa_salida.txt
                 
                 writematrix(u,'C:\Users\fabia\Desktop\IA\elemento_punto_7\umbrales_capa_1.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_7\umbrales_capa_1.txt
                 writematrix(u2,'C:\Users\fabia\Desktop\IA\elemento_punto_7\umbrales_capa_2.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_7\umbrales_capa_2.txt            
                 writematrix(u3,'C:\Users\fabia\Desktop\IA\elemento_punto_7\umbrales_capa_salida.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_7\umbrales_capa_salida.txt
                %------------------guardo pesos----------------------------
               break;
           else
           ...
           if RMS <= errormaximo
               ...
               historial
                %------------------grafico--------------------
                 ...
                 writematrix(w2,'C:\Users\fabia\Desktop\IA\elemento_punto_7\pesos_capa_2.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_7\pesos_capa_2.txt
                 writematrix(w3,'C:\Users\fabia\Desktop\IA\elemento_punto_7\pesos_capa_3.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_7\pesos_capa_3.txt
                 writematrix(w4,'C:\Users\fabia\Desktop\IA\elemento_punto_7\pesos_capa_salida.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_7\pesos_capa_salida.txt
                 ...
                 writematrix(u2,'C:\Users\fabia\Desktop\IA\elemento_punto_7\umbrales_capa_2.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_7\umbrales_capa_2.txt   
                 writematrix(u3,'C:\Users\fabia\Desktop\IA\elemento_punto_7\umbrales_capa_3.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_7\umbrales_capa_3.txt   
                 writematrix(u4,'C:\Users\fabia\Desktop\IA\elemento_punto_7\umbrales_capa_salida.txt','Delimiter',';');
                 type C:\Users\fabia\Desktop\IA\elemento_punto_7\umbrales_capa_salida.txt
                %------------------guardo pesos----------------------------
               break;
           else
